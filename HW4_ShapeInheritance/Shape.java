 ...
 * By Rob Nash
 * 
 * This is the superclass in a hierarchy of shapes that you have
 * to construct.
 */
...
// enough to guess an arbitrary shape's area (future subclasses must override
// getArea() to provide something reasonable)
